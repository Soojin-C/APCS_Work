...
public class Stats {
	...
	System.out.println(gcd(15,20));//expecting 5
	System.out.println(gcd(20,15));//expecting 5 
	System.out.println(gcd(15,17));//expecting 1
	System.out.println(gcd(15,0)); //expecting 0

	System.out.println("========== Testing gcdER ===========");
        System.out.println(gcdER(15,20));//expecting 5
	System.out.println(gcdER(20,15));//expecting 5
	System.out.println(gcdER(15,17));//expecting 1
	System.out.println(gcdER(15,0));//expecting 0
	
	System.out.println("========== Testing gcdEW ===========");
	System.out.println(gcdEW(15,20));//expecting 5
	System.out.println(gcdEW(20,15));//expecting 5
	System.out.println(gcdEW(15,17));//expecting 1
	System.out.println(gcdEW(15,0));//expecting 0
    }   
}
